...
export default function TicketProduct() {
  ...
  義大皇家劇院會不定期舉辦各種精彩的表演，讓遊客好好享受；義大天悅是一個充滿奇幻和神秘氛圍的情境主題樂園，遊客可以在其中體驗各種刺激的遊樂設施。義大世界購物廣場提供各種時尚品牌和精品商店，讓遊客盡情購物；C區的特洛伊城堡亦設有室內遊樂館，館內充滿了各種遊戲和娛樂設施，適合遊客在任何天氣條件下享受遊玩；義大摩天輪一個高聳入雲的摩天輪，提供遊客俯瞰整個義大遊樂世界的全景美景的機會，享受壯觀的景色和令人難忘的旋轉體驗。另外，樂園內設有義大皇家酒店，提供舒適的住宿環境，讓遊客能夠在樂園中輕鬆休息和放鬆`

  //使用須知
  const usetext = `憑證使用方式 現場請出示 QR code`

  //購買須知
  const buytext = `－ 義大遊樂世界購買須知 －
